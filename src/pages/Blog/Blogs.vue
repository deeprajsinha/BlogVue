                ...
                <div class="card-header py-3">
                    <div class="row">
                        ...
                        <div class="col-lg-2" style="float: right">
                            <router-link :to="{ name: 'create-blog' }"><a class="nav-link">
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-2" style="text-align:center;">
                                                  <router-link :to="'/edit-blog/' + blog.id" style="text-align:center;"><i class="fas fa-edit"></i></router-link>
                                                </div>
                                                <div class="col-2" style="text-align:center;">
                                                   <i class="fas fa-trash" style="color:blue; cursor:pointer;" @click="deleteBlog(blog.id)"></i>
                                                </div>
                                            </div>
                                        </td>
